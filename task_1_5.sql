...
drop procedure if exists pc_get_top_oper_type;
delimiter $$
create procedure pc_get_top_oper_type(dt_start datetime, dt_end datetime)
begin
	select @rn := 0;
	select 
		name_oper, 
...
call pc_get_top_oper_type('2023-03-30', '2023-03-31');